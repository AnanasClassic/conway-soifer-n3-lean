...
import ConwaySoifer.Simplified.Certificates.Steps.Aown_300000_310000_0
import ConwaySoifer.Simplified.Certificates.Steps.Aown_300000_310000_1
import ConwaySoifer.Simplified.Certificates.Steps.Aown_300000_310000_2
...
private theorem initial : initModel Data.Aown_300000_310000.case Data.Aown_300000_310000.lo Data.Aown_300000_310000.hi Data.Aown_300000_310000.den = some model0 := by
...
theorem excluded19_0 : ExcludedOn (model19.B 0) (Int.ofNat 9000000000000) (model19.caps 0) (model19.ord 0) 0 (Int.ofNat 1) (Int.ofNat 100) := by
  apply ExclusionHint.sound (.fan [([(Int.ofNat 5100000000000)], [(Int.ofNat 600000000000)]), ([(Int.ofNat 5100000000000)], [(Int.ofNat 750000000000)]), ([(Int.ofNat 4125000000000)], [(Int.ofNat 825000000000)]), ([(Int.ofNat 2790000000000)], [(Int.ofNat 600000000000)]), ([(Int.ofNat 3975000000000)], [(Int.ofNat 975000000000)]), ([(Int.ofNat 4500000000000)], [(Int.ofNat 1950000000000)]), ([(Int.ofNat 2775000000000)], [(Int.ofNat 1575000000000)]), ([(Int.ofNat 4275000000000)], [(Int.ofNat 3240000000000)]), ([(Int.ofNat 750000000000)], [(Int.ofNat 600000000000)]), ([(Int.ofNat 600000000000)], [(Int.ofNat 600000000000)]), ([(Int.ofNat 1275000000000)], [(Int.ofNat 2475000000000)]), ([(Int.ofNat 1710000000000)], [(Int.ofNat 3390000000000)]), ([(Int.ofNat 1710000000000)], [(Int.ofNat 3540000000000)]), ([(Int.ofNat 1650000000000)], [(Int.ofNat 4575000000000)]), ([(Int.ofNat 1500000000000)], [(Int.ofNat 4725000000000)]), ([(Int.ofNat 1110000000000)], [(Int.ofNat 4740000000000)]), ([(Int.ofNat 525000000000)], [(Int.ofNat 4515000000000)]), ([(Int.ofNat 300000000000)], [(Int.ofNat 5325000000000)]), ([(Int.ofNat 150000000000)], [(Int.ofNat 4725000000000)]), ([(Int.ofNat 0)], [(Int.ofNat 150000000000)]), ([(Int.negSucc 599999999999)], [(Int.ofNat 5700000000000)]), ([(Int.negSucc 749999999999)], [(Int.ofNat 5850000000000)]), ([(Int.negSucc 824999999999)], [(Int.ofNat 4950000000000)]), ([(Int.negSucc 599999999999)], [(Int.ofNat 3390000000000)]), ([(Int.negSucc 974999999999)], [(Int.ofNat 4950000000000)]), ([(Int.negSucc 1949999999999)], [(Int.ofNat 6450000000000)]), ([(Int.negSucc 1574999999999)], [(Int.ofNat 4350000000000)]), ([(Int.negSucc 3239999999999)], [(Int.ofNat 7515000000000)]), ([(Int.negSucc 599999999999)], [(Int.ofNat 1350000000000)]), ([(Int.negSucc 599999999999)], [(Int.ofNat 1200000000000)]), ([(Int.negSucc 2474999999999)], [(Int.ofNat 3750000000000)]), ([(Int.negSucc 3389999999999)], [(Int.ofNat 5100000000000)]), ([(Int.negSucc 3539999999999)], [(Int.ofNat 5250000000000)]), ([(Int.negSucc 4574999999999)], [(Int.ofNat 6225000000000)]), ([(Int.negSucc 4724999999999)], [(Int.ofNat 6225000000000)]), ([(Int.negSucc 4739999999999)], [(Int.ofNat 5850000000000)]), ([(Int.negSucc 4514999999999)], [(Int.ofNat 5040000000000)]), ([(Int.negSucc 5324999999999)], [(Int.ofNat 5625000000000)]), ([(Int.negSucc 4724999999999)], [(Int.ofNat 4875000000000)]), ([(Int.negSucc 0)], [(Int.ofNat 1)])]) (den := (Int.ofNat 9000000000000)) (fuel := 12) (by decide +kernel) 0 (Int.ofNat 1) (Int.ofNat 100) (by decide +kernel)
  decide +kernel
...
theorem Aown_300000_310000_checked : Data.Aown_300000_310000.Valid := by
  apply certificate_checkpoint Data.Aown_300000_310000 Aown_300000_310000.model0 (Int.ofNat 9000000000000) (Int.ofNat 1) (Int.ofNat 100)
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Aown_300000_310000.initial
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Aown_300000_310000.tail0
