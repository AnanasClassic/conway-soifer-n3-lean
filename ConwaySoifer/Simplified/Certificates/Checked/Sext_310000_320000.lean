...
import ConwaySoifer.Simplified.Certificates.Steps.Sext_310000_320000_0
import ConwaySoifer.Simplified.Certificates.Steps.Sext_310000_320000_1
import ConwaySoifer.Simplified.Certificates.Steps.Sext_310000_320000_2
import ConwaySoifer.Simplified.Certificates.Steps.Sext_310000_320000_3
...
private theorem initial : initModel Data.Sext_310000_320000.case Data.Sext_310000_320000.lo Data.Sext_310000_320000.hi Data.Sext_310000_320000.den = some model0 := by
  apply initial_checkpoint
  · decide +kernel
  all_goals intro j; fin_cases j <;> decide +kernel

theorem excluded32_2 : ExcludedOn (model32.B 2) (Int.ofNat 9000000000000) (model32.caps 2) (model32.ord 2) 0 (Int.ofNat 1) (Int.ofNat 100) := by
  apply ExclusionHint.sound (.fan [([(Int.ofNat 5745000000000), (Int.ofNat 9000000000000)], [(Int.ofNat 630000000000), (Int.negSucc 8999999999999)]), ([(Int.ofNat 915000000000)], [(Int.ofNat 165000000000)]), ([(Int.ofNat 4665000000000), (Int.ofNat 9000000000000)], [(Int.ofNat 1545000000000), (Int.negSucc 8999999999999)]), ([(Int.ofNat 2955000000000)], [(Int.ofNat 3420000000000)]), ([(Int.ofNat 2790000000000), (Int.ofNat 9000000000000)], [(Int.ofNat 5397000000000), (Int.ofNat 0)]), ([(Int.ofNat 1875000000000)], [(Int.ofNat 4335000000000)]), ([(Int.ofNat 978000000000)], [(Int.ofNat 2442000000000)]), ([(Int.ofNat 813000000000)], [(Int.ofNat 3522000000000)]), ([(Int.ofNat 0)], [(Int.ofNat 5397000000000)]), ([(Int.negSucc 629999999999), (Int.ofNat 9000000000000)], [(Int.ofNat 6375000000000), (Int.ofNat 0)]), ([(Int.negSucc 164999999999)], [(Int.ofNat 1080000000000)]), ([(Int.negSucc 1544999999999), (Int.ofNat 9000000000000)], [(Int.ofNat 6210000000000), (Int.ofNat 0)]), ([(Int.negSucc 3419999999999)], [(Int.ofNat 6375000000000)]), ([(Int.negSucc 5396999999999), (Int.ofNat 0)], [(Int.ofNat 8187000000000), (Int.ofNat 9000000000000)]), ([(Int.negSucc 4334999999999)], [(Int.ofNat 6210000000000)]), ([(Int.negSucc 2441999999999)], [(Int.ofNat 3420000000000)]), ([(Int.negSucc 3521999999999)], [(Int.ofNat 4335000000000)]), ([(Int.negSucc 0)], [(Int.ofNat 1)])]) (den := (Int.ofNat 9000000000000)) (fuel := 12) (by decide +kernel) 0 (Int.ofNat 1) (Int.ofNat 100) (by decide +kernel)
  decide +kernel

private theorem tail32 : ModelImpossible model32 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  final_checkpoint model32 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) 2 excluded32_2
...
theorem Sext_310000_320000_checked : Data.Sext_310000_320000.Valid := by
  apply certificate_checkpoint Data.Sext_310000_320000 Sext_310000_320000.model0 (Int.ofNat 9000000000000) (Int.ofNat 1) (Int.ofNat 100)
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Sext_310000_320000.initial
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Sext_310000_320000.tail0
