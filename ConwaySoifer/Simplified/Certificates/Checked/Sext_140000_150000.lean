...
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_0
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_1
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_2
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_3
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_4
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_5
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_6
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_7
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_8
import ConwaySoifer.Simplified.Certificates.Steps.Sext_140000_150000_9
...
private theorem initial : initModel Data.Sext_140000_150000.case Data.Sext_140000_150000.lo Data.Sext_140000_150000.hi Data.Sext_140000_150000.den = some model0 := by
  apply initial_checkpoint
  · decide +kernel
  all_goals intro j; fin_cases j <;> decide +kernel

theorem excluded76_1 : ExcludedOn (model76.B 1) (Int.ofNat 9000000000000) (model76.caps 1) (model76.ord 1) 0 (Int.ofNat 1) (Int.ofNat 100) := by
  apply ExclusionHint.sound (.fan [([(Int.ofNat 5580000000000)], [(Int.ofNat 630000000000)]), ([(Int.ofNat 4320000000000), (Int.negSucc 8999999999999)], [(Int.ofNat 630000000000), (Int.ofNat 0)]), ([(Int.ofNat 3510000000000), (Int.ofNat 9000000000000)], [(Int.ofNat 2700000000000), (Int.negSucc 8999999999999)]), ([(Int.ofNat 4830000000000)], [(Int.ofNat 4710000000000)]), ([(Int.ofNat 1260000000000), (Int.ofNat 9000000000000)], [(Int.ofNat 1260000000000), (Int.ofNat 9000000000000)]), ([(Int.ofNat 2250000000000)], [(Int.ofNat 3960000000000)]), ([(Int.ofNat 1500000000000)], [(Int.ofNat 3960000000000)]), ([(Int.ofNat 1500000000000)], [(Int.ofNat 4710000000000)]), ([(Int.ofNat 990000000000), (Int.negSucc 8999999999999)], [(Int.ofNat 3960000000000), (Int.ofNat 0)]), ([(Int.ofNat 630000000000), (Int.ofNat 9000000000000)], [(Int.ofNat 6210000000000)]), ([(Int.ofNat 240000000000), (Int.negSucc 8999999999999)], [(Int.ofNat 5220000000000), (Int.ofNat 9000000000000)]), ([(Int.ofNat 0)], [(Int.ofNat 3330000000000)]), ([(Int.negSucc 629999999999)], [(Int.ofNat 6210000000000)]), ([(Int.negSucc 629999999999), (Int.ofNat 0)], [(Int.ofNat 4950000000000), (Int.negSucc 8999999999999)]), ([(Int.negSucc 2699999999999), (Int.ofNat 9000000000000)], [(Int.ofNat 6210000000000)]), ([(Int.negSucc 4709999999999)], [(Int.ofNat 9540000000000)]), ([(Int.negSucc 1259999999999), (Int.negSucc 8999999999999)], [(Int.ofNat 2520000000000), (Int.ofNat 18000000000000)]), ([(Int.negSucc 3959999999999)], [(Int.ofNat 6210000000000)]), ([(Int.negSucc 3959999999999)], [(Int.ofNat 5460000000000)]), ([(Int.negSucc 4709999999999)], [(Int.ofNat 6210000000000)]), ([(Int.negSucc 3959999999999), (Int.ofNat 0)], [(Int.ofNat 4950000000000), (Int.negSucc 8999999999999)]), ([(Int.negSucc 6209999999999)], [(Int.ofNat 6840000000000), (Int.ofNat 9000000000000)]), ([(Int.negSucc 5219999999999), (Int.negSucc 8999999999999)], [(Int.ofNat 5460000000000), (Int.ofNat 0)]), ([(Int.negSucc 0)], [(Int.ofNat 1)])]) (den := (Int.ofNat 9000000000000)) (fuel := 12) (by decide +kernel) 0 (Int.ofNat 1) (Int.ofNat 100) (by decide +kernel)
  decide +kernel

private theorem tail76 : ModelImpossible model76 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  final_checkpoint model76 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) 1 excluded76_1
private theorem tail75 : ModelImpossible model75 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model75 model76 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step75 next75 checked75 tail76
private theorem tail74 : ModelImpossible model74 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model74 model75 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step74 next74 checked74 tail75
private theorem tail73 : ModelImpossible model73 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model73 model74 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step73 next73 checked73 tail74
private theorem tail72 : ModelImpossible model72 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model72 model73 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step72 next72 checked72 tail73
private theorem tail71 : ModelImpossible model71 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model71 model72 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step71 next71 checked71 tail72
private theorem tail70 : ModelImpossible model70 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model70 model71 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step70 next70 checked70 tail71
private theorem tail69 : ModelImpossible model69 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model69 model70 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step69 next69 checked69 tail70
private theorem tail68 : ModelImpossible model68 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model68 model69 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step68 next68 checked68 tail69
private theorem tail67 : ModelImpossible model67 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model67 model68 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step67 next67 checked67 tail68
private theorem tail66 : ModelImpossible model66 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model66 model67 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step66 next66 checked66 tail67
private theorem tail65 : ModelImpossible model65 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model65 model66 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step65 next65 checked65 tail66
private theorem tail64 : ModelImpossible model64 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  replay_checkpoint model64 model65 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) step64 next64 checked64 tail65
...
theorem Sext_140000_150000_checked : Data.Sext_140000_150000.Valid := by
  apply certificate_checkpoint Data.Sext_140000_150000 Sext_140000_150000.model0 (Int.ofNat 9000000000000) (Int.ofNat 1) (Int.ofNat 100)
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Sext_140000_150000.initial
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Sext_140000_150000.tail0
