...
import ConwaySoifer.Simplified.Certificates.Steps.Sext_330000_340000_0
import ConwaySoifer.Simplified.Certificates.Steps.Sext_330000_340000_1
import ConwaySoifer.Simplified.Certificates.Steps.Sext_330000_340000_2
import ConwaySoifer.Simplified.Certificates.Steps.Sext_330000_340000_3
...
private theorem initial : initModel Data.Sext_330000_340000.case Data.Sext_330000_340000.lo Data.Sext_330000_340000.hi Data.Sext_330000_340000.den = some model0 := by
  apply initial_checkpoint
  · decide +kernel
  all_goals intro j; fin_cases j <;> decide +kernel

theorem excluded29_0 : ExcludedOn (model29.B 0) (Int.ofNat 9000000000000) (model29.caps 0) (model29.ord 0) 0 (Int.ofNat 1) (Int.ofNat 100) := by
  apply ExclusionHint.sound (.fan [([(Int.ofNat 7890000000000)], [(Int.ofNat 90000000000)]), ([(Int.ofNat 7326000000000)], [(Int.ofNat 750000000000)]), ([(Int.ofNat 4785000000000)], [(Int.ofNat 2070000000000)]), ([(Int.ofNat 2340000000000)], [(Int.ofNat 1125000000000)]), ([(Int.ofNat 1980000000000)], [(Int.ofNat 1125000000000)]), ([(Int.ofNat 4221000000000)], [(Int.ofNat 2730000000000)]), ([(Int.ofNat 1980000000000)], [(Int.ofNat 1485000000000)]), ([(Int.ofNat 1395000000000)], [(Int.ofNat 4515000000000)]), ([(Int.ofNat 96000000000)], [(Int.ofNat 564000000000)]), ([(Int.ofNat 735000000000)], [(Int.ofNat 4611000000000)]), ([(Int.negSucc 89999999999)], [(Int.ofNat 7980000000000)]), ([(Int.negSucc 749999999999)], [(Int.ofNat 8076000000000)]), ([(Int.negSucc 2069999999999)], [(Int.ofNat 6855000000000)]), ([(Int.negSucc 1124999999999)], [(Int.ofNat 3465000000000)]), ([(Int.negSucc 1124999999999)], [(Int.ofNat 3105000000000)]), ([(Int.negSucc 2729999999999)], [(Int.ofNat 6951000000000)]), ([(Int.negSucc 1484999999999)], [(Int.ofNat 3465000000000)]), ([(Int.negSucc 4514999999999)], [(Int.ofNat 5910000000000)]), ([(Int.negSucc 563999999999)], [(Int.ofNat 660000000000)]), ([(Int.negSucc 4610999999999)], [(Int.ofNat 5346000000000)]), ([(Int.negSucc 0)], [(Int.ofNat 1)])]) (den := (Int.ofNat 9000000000000)) (fuel := 12) (by decide +kernel) 0 (Int.ofNat 1) (Int.ofNat 100) (by decide +kernel)
  decide +kernel

private theorem tail29 : ModelImpossible model29 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  final_checkpoint model29 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) 0 excluded29_0
...
theorem Sext_330000_340000_checked : Data.Sext_330000_340000.Valid := by
  apply certificate_checkpoint Data.Sext_330000_340000 Sext_330000_340000.model0 (Int.ofNat 9000000000000) (Int.ofNat 1) (Int.ofNat 100)
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Sext_330000_340000.initial
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Sext_330000_340000.tail0
