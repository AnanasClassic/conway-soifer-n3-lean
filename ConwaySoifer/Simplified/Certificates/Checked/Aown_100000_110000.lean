...
import ConwaySoifer.Simplified.Certificates.Steps.Aown_100000_110000_0
import ConwaySoifer.Simplified.Certificates.Steps.Aown_100000_110000_1
...
private theorem initial : initModel Data.Aown_100000_110000.case Data.Aown_100000_110000.lo Data.Aown_100000_110000.hi Data.Aown_100000_110000.den = some model0 := by
  apply initial_checkpoint
  · decide +kernel
  all_goals intro j; fin_cases j <;> decide +kernel

theorem excluded16_0 : ExcludedOn (model16.B 0) (Int.ofNat 9000000000000) (model16.caps 0) (model16.ord 0) 0 (Int.ofNat 1) (Int.ofNat 100) := by
...
private theorem tail16 : ModelImpossible model16 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) :=
  final_checkpoint model16 (Int.ofNat 9000000000000) 0 (Int.ofNat 1) (Int.ofNat 100) 0 excluded16_0
...
theorem Aown_100000_110000_checked : Data.Aown_100000_110000.Valid := by
  apply certificate_checkpoint Data.Aown_100000_110000 Aown_100000_110000.model0 (Int.ofNat 9000000000000) (Int.ofNat 1) (Int.ofNat 100)
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Aown_100000_110000.initial
  · decide +kernel
  · decide +kernel
  · decide +kernel
  · exact Aown_100000_110000.tail0
